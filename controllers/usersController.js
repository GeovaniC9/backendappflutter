...
module.exports = {
    ...
    async registerWithImage(req, res, next) {
        try {
            ...
            if (files.length > 0) {
                const pathImage = `image_${Date.now()}`; //Nombre del archivo que se almacena
    ...
    async update(req, res, next) {
        try {
            ...
            return res.status(201).json({
                success: true,
                message: 'Datos del usuario actualizadas satisfactoriamente'
            ...
            return res.status(501).json({
                success: true,
                message: 'Hubo un error al actualizar datos del usuario',
                error: error
            });
